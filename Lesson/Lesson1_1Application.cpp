...
#include "Lesson1_1Application.h"

BaseApplication *app = new Lesson1_1Application;

const std::vector<Program::ShaderConfig> Lesson1_1Application::getShaderConfigs() const
{
    return {
        {
            GL_VERTEX_SHADER,
...
void Lesson1_1Application::setup(GLFWwindow *window)
{
...
void Lesson1_1Application::draw()
{
